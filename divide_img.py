...
def cropImagem(img,conth,contw,idx):
	boxes3 = []
	scores3 = []
	boxes4 = []
	scores4 = []
	...
	desenha(img,boxes4,scores4,idx)    
...
def desenha(image,boxes,scores,idx):
	f = open("pontos"+str(idx)+".txt", "w")
	f.write("meioX" + "," + "meioY" + "\n")
	draw = image.copy()
	...
	f.close()
	print(cont)
	cv2.imwrite("result"+str(idx)+".tif",image)

#LOAD MODEL
PATH_TO_CKPT = "plantas4.pb"
